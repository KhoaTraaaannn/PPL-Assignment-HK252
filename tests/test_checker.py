...
def test_219():
    ...
    """
        assert Checker(source).check_from_source() == "TypeMismatchInStatement(VarDecl(FloatType(), c = Identifier(a)))"
...
def test_242():
    ...
    """
        assert Checker(source).check_from_source() == "TypeCannotBeInferred(AssignExpr(Identifier(b) = Identifier(c)))"    
def test_243():
        source = """
    void main() {
        auto a;
...
def test_324():
    ...
    """
        assert Checker(source).check_from_source() == "TypeMismatchInExpression(BinaryOp(IntLiteral(1), +, StructLiteral({IntLiteral(1), IntLiteral(2)})))"       
def test_329():
        source = """
    void main() {
        auto a; auto b;
